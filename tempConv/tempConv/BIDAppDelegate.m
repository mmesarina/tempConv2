...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // MALENA BEGIN
    //initialized and instantiate your Controller
    BIDViewController *tempViewController = [[BIDViewController alloc] init];
    ...
    //set rootViewContoller to be the navigationController
